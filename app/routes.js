...
module.exports = function(app, passport) {
    ...
    app.post('/saveSetup', function(req, res){
        setupController.saveSetup({username: req.user.twitter.username, value: req.body.value},
                                    function(data){
                                      res.send(data);
                          })
    });

    app.delete('/deleteSetup', function(req, res){
      console.log('ID: '+ req.body.id);
        setupController.deleteSetup({id: req.body.id},
                                     function(data){
                                        res.send(data);
                                    })
    });
